...
# Major-feature sanity checks (analyzer pipeline + code actions) now live in
# tests/test_server.py, which is NOT gated by the jdtls skipif above. They run
# in the regular unit matrix on every Python version and contribute to the 80%
# coverage floor without requiring jdtls to be installed.
