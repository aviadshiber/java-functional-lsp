...
_MESSAGES = {
    "throw-statement": "Avoid throwing exceptions. Use Either.left(error) or Try.of(() -> ...).toEither() for error handling.",
    "catch-rethrow": "Avoid catching and rethrowing exceptions. Use Try.of(() -> ...).toEither() to convert exceptions to values.",
}
